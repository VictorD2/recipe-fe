...
import { defaultBorder, defaultSeparator, defaultSize } from "./Dropdown.default";
...
const DropdownMenu: FC<DropdownMenuProps> = (props) => {
  ...
  const handleOpenDropdown = (e: React.MouseEvent) => {
    ...
    const isNearLeftEdge = botonRect.left < 2;
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
        <Menu.Items
          ...
          className={classNames(
            ...
            outOfWindowmRight
              ...
              ? "-top-1 -right-[10.7rem]"
              : positionAbs,
            "absolute rounded-md focus:outline-none z-[500]",
            sizeStyle.width,
            sizeStyle.height,
        ...
        >
          <Container border={borderStyle} bgColor={bgColor} >
            {children}
          </Container>
        </Menu.Items>
      </Transition>
